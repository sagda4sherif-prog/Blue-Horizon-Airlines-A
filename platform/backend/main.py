"""
Don't launch this with `uvicorn platform.backend.main:app` — the folder
...
The MCP server itself must be runnable at mcp_server/server.py (it is —
...
app = FastAPI(title="Blue Horizon Airlines — Ops Platform API")
